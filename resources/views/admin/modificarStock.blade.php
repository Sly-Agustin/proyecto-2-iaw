...
<div class="container">
    ...
    <form id="actionLabel" method="POST" action="{{ action('adminController@modificarStockPost') }}">
    ...
    <form id="actionLabel" method="POST" action="{{ action('adminController@agregarProductoVentaPost') }}">
